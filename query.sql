...
update DateTime set c_datetimeoffset = '2024-04-02 06:33:41.1533333 +10:00'
where c_datetimeoffset = '2024-04-02 06:33:41.1533333 +00:00'

SELECT CURRENT_TIMESTAMP, 'CURRENT_TIMESTAMP' --aja paring
SELECT SYSDATETIME(), 'SYSDATETIME'
SELECT SYSDATETIMEOFFSET(),'SYSDATETIMEOFFSET'-- tapne aeg ajalise nihkega UTC suhtes
SELECT GETUTCDATE(), 'GETUTCDATE' --UTC aeg

SELECT isdate('asd') --tagastab 0 kuna string ei ole date andmetyyp
SELECT ISDATE(GETDATE()) --tagastab 1, kuna on kuupaev
SELECT ISDATE('2024-04-02 06:33:41.1533333') -- tagastab 0 kuna max 3 komakohta voib olla
SELECT ISDATE('2024-04-02 06:33:41.153')
SELECT DAY(GETDATE()) -- tagastab tanase paeva numbri
SELECT DAY('04/15/2024') --tagastab paeva
SELECT Month(GETDATE())
SELECT Month('04/15/2024')
SELECT Year(GETDATE())
SELECT Year('04/15/2024')

SELECT DATENAME(day,'2024-04-02 06:33:41.153') -- annam stringis oleva paeva numbri
SELECT DATENAME(weekday,'1984-11-19 06:33:41.153') -- annam stringis oleva paeva
SELECT DATENAME(MONTH,'2024-04-02 06:33:41.153') -- annam stringis oleva kuu

CREATE table EmloyeesWithDates
(
    Id NVARCHAR(2),
    Name NVARCHAR(20),
...
INSERT into EmloyeesWithDates VALUES (1, 'Sam', '1980-12-30 00:00:00.000')
INSERT into EmloyeesWithDates VALUES (2, 'Pam', '1982-09-01 12:02:36.260')
INSERT into EmloyeesWithDates VALUES (3, 'John', '1985-08-22 12:03:30.370')
INSERT into EmloyeesWithDates VALUES (4, 'Sara', '1979-11-29 12:59:30.670')
INSERT into EmloyeesWithDates VALUES (5, 'Todd', '1978-11-29 12:59:30.670')

SELECT * from EmloyeesWithDates

--- kuidas votta yhest veerust andmeid ja selle abil luua uued andmed
SELECT Name, DateOfBirth, DATENAME(weekday, DateOfBirth) as [Day], -- vaatab DOB veerust paeva ja kuvab paeva nimetuse sonana
        MONTH(DateOfBirth) as MonthNumber, --vt DoB veerust kp ja kuvab kuu numbri
        DateName(MONTH, DateOfBirth) as [MonthName], -- DoB veerust kuu ja kuvab sonana
        YEAR(DateOfBirth) as [Year] -- DoB veerust aasta
FROM EmloyeesWithDates

SELECT DATEPART(WEEKDAY, '2024-04-02 06:33:41.153') -- kuvab 3 kuna nadal algab pyhapaevaga
SELECT DATEPART(MONTH, '2024-04-02 06:33:41.153')
SELECT DATEAdd(DAY, 20, '2024-04-02 06:33:41.153') --liidab paevale 20 paeva juurde
SELECT DATEAdd(DAY, -20, '2024-04-02 06:33:41.153') --lahutab paevale 20 paeva
SELECT DATEDiff(Month, '11/29/2023', '04/02/2024') -- kahe stringi kuudevaheline aeg numbrina
SELECT DATEDiff(YEAR, '11/29/2023', '04/02/2024')-- kahe stringi aastavaheline aeg numbrina
...
SELECT Id, Name, DateOfBirth, dbo.fnComputeAge(DateOfBirth) as Age from EmloyeesWithDates

-- kui kasutame seda funktsiooni, siis saame teada tanase paeva vahet stringis valja tooduga
SELECT dbo.fnComputeAge('11/19/1984')

-- nr peale DoB muutujat naitab, et mismoodi kuvada DoB-d
SELECT Id, Name, DateOfBirth,
CONVERT(nvarchar, DateOfBirth, 126) as ConvertedDoB --proovi 102-ga voi 107-ga (101 - 127)
FROM EmloyeesWithDates

SELECT Id, Name, Name + ' - ' + CAST(Id as nvarchar) as [Name-Id] from EmloyeesWithDates

SELECT CAST(GETDATE() as date) -- tanane kp
SELECT CONVERT(date, GETDATE())

------
-- matemaatilised funktsioonid

SELECT ABS(-101.5) -- absoluutvaartus
SELECT CEILING(15.2) -- ymardab yles
SELECT CEILING(-15.2)
SELECT FLOOR(15.2) -- ymardab alla
SELECT FLOOR(-15.2)
SELECT POWER(2, 4) -- astendab
SELECT SQUARE(4) -- ruut
SELECT SQRT(81) -- ruutjuur

SELECT RAND() -- annab suvalise numbri
SELECT FLOOR(RAND() * 100) -- suvaline taisarv

-- iga kord naitab 10 suvalist numbrit
DECLARE @counter INT
SET @counter = 1
WHILE (@counter <= 10)
BEGIN
...
SELECT ROUND(850.454, 0) --ymardab lahima taisarvuni, vottes arvesse ainult esimese numbri peale koma
SELECT ROUND(850.554, -2)
...
-- arvutab valja, kui vana on isik ja votab arvesse kuud ja paevad
--antud juhul naitab koike, kes on yle 36 a vanad

select Id, Name, dbo.CalculateAge(DateOfBirth) as Age from EmloyeesWithDates
where dbo.CalculateAge(DateOfBirth)  > 42

alter TABLE EmloyeesWithDates
add DepartmentId INT
alter TABLE EmloyeesWithDates
add Gender NVARCHAR(10)

update EmloyeesWithDates set DepartmentId = 1 where Id = 1
update EmloyeesWithDates set Gender = 'Male' where Id = 1

update EmloyeesWithDates set DepartmentId = 2 where Id = 2
update EmloyeesWithDates set Gender = 'Female' where Id = 2

update EmloyeesWithDates set DepartmentId = 1 where Id = 3
update EmloyeesWithDates set Gender = 'Male' where Id = 3

update EmloyeesWithDates set DepartmentId = 3 where Id = 4
update EmloyeesWithDates set Gender = 'Female' where Id = 4

update EmloyeesWithDates set DepartmentId = 1 where Id = 5
update EmloyeesWithDates set Gender = 'Male' where Id = 5
